...
const mockTransactions = [
  { id: 'TX-1021', item: 'Crimson Ballgown', username: 'Alice', date: '2026-06-01', status: 'Completed', amount: '1,500' },
  { id: 'TX-1022', item: 'Emerald Evening Gown', username: 'Bob', date: '2026-06-02', status: 'Pending', amount: '2,000' },
  { id: 'TX-1023', item: 'Sapphire Tuxedo', username: 'Charlie', date: '2026-06-03', status: 'Completed', amount: '2,500' },
];

vi.mock('../../services/inventoryApiClient', () => ({
  getTransactions: vi.fn(() => Promise.resolve({ status: 'success', data: mockTransactions })),
}));
